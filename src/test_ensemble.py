...
def main():
    ...
    if retest:
        ...
        for proc in procs:
            while True:
                # next_err_line = proc.stderr.readline().decode('utf-8')
        ...
        procs_out = ['/mnt/tank/scratch/mkashirin/storage_for_large_models_and_code_from_home/mri_scans_project/src/ensemble_predictions/best_nii_mc_sch_dp=0.3_tf_seed=100_nasnet_sch_dp__predicts.npy',
                     '/mnt/tank/scratch/mkashirin/storage_for_large_models_and_code_from_home/mri_scans_project/src/ensemble_predictions/best_nii_mc_sch_dp=0.3_tf_seed=200_nasnet_sch_dp__predicts.npy']
    ...
    for f_path in procs_out:
        ...
        models_predicts = new_pred if models_predicts is None else np.concatenate((models_predicts, new_pred), axis=1)
