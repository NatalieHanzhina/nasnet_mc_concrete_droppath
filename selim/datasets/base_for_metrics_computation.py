...
class BaseMaskAndPathDatasetIterator(Iterator):
    def __init__(self,
                 images_dir,
                 masks_dir,
                 image_ids,
        ...
        super(BaseMaskAndPathDatasetIterator, self).__init__(len(self.image_ids), batch_size, shuffle, seed)
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        #input()
        return preprocessed_t_x, t_y, paths
